...
1. **Simulate:** Use the sliders in the sidebar to set the "Daily Patients" and "Doctor Work Pace".
2. **Analyze:** Check the **Flow & Bottlenecks** tab to see where the queue builds up.
3. **Audit:** Go to the **Detailed Ledger** to see a row-by-row breakdown of every patient's
    journey.
4. **Export:** Click **Export Log as CSV** to save the simulated data for external reporting.
